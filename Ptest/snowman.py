...
class Snow:
    def __init__(self, cvns, points, w=150, h=450):
        ...
        self.head = Head(self.cvns, (self.points[0], self.points[1] + self.h / 6), self.w, self.h)
        self.body = Body(self.cvns, (self.points[0], self.points[1] + self.h / 2), self.w, self.h)
