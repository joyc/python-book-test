...
def create_role():
    # 1. 访问者
    visitor = CMSRole(name='访问者', desc='只能访问相关数据。')
    visitor.permissions = CMSPermission.VISITOR

    # 2. 运营者（修改个人信息管理帖子评论和前台用户）
    ...
    admin.permissions = CMSPermission.VISITOR | CMSPermission.POSTER | CMSPermission.POSTER | CMSPermission.CMSUSER \
